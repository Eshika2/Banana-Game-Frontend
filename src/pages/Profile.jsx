...
export default function Profile() {
  ...
  const [userData, setUserData] = useState({
    profile_img: localStorage.getItem("avatar") || "",
    user_name: "",
    email: "",
    created_at: "",
    level: 0,
  ...
  return (
    ...
    >
      ...
      {/* Content Wrapper */}
      <div className="relative z-10 max-w-3xl mx-auto px-6 pt-20 pb-10 text-white">
        <h1 className="text-center text-5xl font-extrabold text-orange-400 drop-shadow-lg mb-10">
          My Profile
        </h1>

        {/* Profile Info */}
        <div className="flex flex-col sm:flex-row items-center gap-6 bg-black/50 backdrop-blur-md p-6 rounded-xl shadow-xl">
          <img
          ...
          <div className="text-lg space-y-1">
            ...
            <p>
              <span className="font-bold text-red-500">Member Since:</span>{" "}
        ...
        {/* Stats */}
        <div className="mt-10 bg-black/50 backdrop-blur-md p-6 rounded-xl shadow-lg">
